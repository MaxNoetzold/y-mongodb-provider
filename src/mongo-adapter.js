...
export class MongoAdapter {
	 ...
	 * @param {boolean} [opts.multipleCollections] When set to true, each document gets an own collection (instead of all documents stored in the same one). When set to true, the option collection gets ignored.
	 */
